...
class EngineControllerSystem extends JControllerLegacy
{
    public function getModel($name = 'System', $prefix = 'EngineModel', $config=array('ignore_request' => true))
    {
        return parent::getModel($name, $prefix, $config);
    }

    public function checkMailOpened()
    {
